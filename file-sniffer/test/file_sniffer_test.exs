defmodule FileSnifferTest do
  ...
  @bmp_file File.read!(Path.join(["file-sniffer", "assets", "bmp.bmp"]))
  @gif_file File.read!(Path.join(["file-sniffer", "assets", "gif.gif"]))
  @jpg_file File.read!(Path.join(["file-sniffer", "assets", "jpeg.jpg"]))
  @png_file File.read!(Path.join(["file-sniffer", "assets", "png-transparent.png"]))
  @exe_file File.read!(Path.join(["file-sniffer", "assets", "elf.o"]))
