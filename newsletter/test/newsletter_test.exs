defmodule NewsletterTest do
  ...
  @temp_file_path Path.join(["newsletter", "assets", "temp.txt"])
  ...
  describe "read_emails" do
    ...
    test "returns a list of all lines in a file" do
      emails_file_path = Path.join(["newsletter", "assets", "emails.txt"])
    ...
    test "returns an empty list if the file is empty" do
      empty_file_path = Path.join(["newsletter", "assets", "empty.txt"])
  ...
  describe "send_newsletter" do
    ...
    test "returns ok" do
      ...
      assert Newsletter.send_newsletter(
               Path.join(["newsletter", "assets", "emails.txt"]),
               @temp_file_path,
               send_fun
             ) == :ok
    end
    ...
    test "calls send function for every email from the emails file" do
      ...
      Newsletter.send_newsletter(Path.join(["newsletter", "assets", "emails.txt"]), @temp_file_path, send_fun)
